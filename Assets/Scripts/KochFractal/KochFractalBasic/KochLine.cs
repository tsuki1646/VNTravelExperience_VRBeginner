...
public class KochLine : KochGenerator
{
    ...
    public float _emisionMultiplier;
    ...
    void Update()
    {
        _matInstance.SetColor("_EmissionColor", _color * _audioPeer._audioBandBuffer[_audioBandMaterial] * _emisionMultiplier);
        ...
        if (_generationCount != 0 )
        {
            ...
            if (_useBezierCurves)
            {
                _bezierPosition = BezierCurve(_lerpPosition, _bezierVertextCount);
